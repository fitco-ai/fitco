import { getSizeResultSummary } from '@/actions/size-result/getSizeResultSummary';
import {
  getClientIp,
  getHeaders,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const getSizeResultSummaryResponse = await getSizeResultSummary(
      memberId,
    ...
    const responseData =
      getSizeResultSummaryResponse.data as GetSizeResultResponseData;
