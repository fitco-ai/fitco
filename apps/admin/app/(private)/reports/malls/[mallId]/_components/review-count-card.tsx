...
import { useReviewCountByMallId } from '@/queries/dashboard';
import {
  Card,
  CardContent,
  CardHeader,
...
export function ReviewCountCard({ mallId }: { mallId: number }) {
  const { selectedShopNo } = useMallReportContext();
  const { data, isLoading } = useReviewCountByMallId(mallId, selectedShopNo);
